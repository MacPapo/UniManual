...
*** Standard IEEE754
    - Singola precisione ( 32 BIT ) -> L' intervallo di valori (decimali) rappresentabili è +_ ~10^-44.85 -- ~10^38.53
    - Doppia precisione ( 64 BIT ) ->  L' intervallo di valori ( decimali ) rappresentabili è +_ ~10^-323.3 -- ~10^308.3
